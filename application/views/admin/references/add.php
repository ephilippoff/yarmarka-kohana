<form class="form-horizontal" method="post" enctype="multipart/form-data">
		...
		<div class="controls">
			<select name="attribute">
				<?php foreach ($attributes as $attribute) : ?>
					<option value="<?=$attribute->id?>"><?=$attribute->title?> (<?=$attribute->id?>)</option>
				<?php endforeach; ?>
			</select>			
	...
	<div class="control-group <?=Arr::get($errors, 'is_required') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'is_required')?>" class="input-block-level" name="is_required" id="is_required"  />
	...
	<div class="control-group <?=Arr::get($errors, 'is_title') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'is_title')?>" class="input-block-level" name="is_title" id="is_title"  />
	...
	<div class="control-group <?=Arr::get($errors, 'attribute_cols_count') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'attribute_cols_count')?>" class="input-block-level" name="attribute_cols_count" id="attribute_cols_count"  />
	...
	<div class="control-group <?=Arr::get($errors, 'is_seo_used') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'is_seo_used')?>" class="input-block-level" name="is_seo_used" id="is_seo_used"  />
	...
	<div class="control-group <?=Arr::get($errors, 'is_selectable') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'is_selectable')?>" class="input-block-level" name="is_selectable" id="is_selectable"  />
