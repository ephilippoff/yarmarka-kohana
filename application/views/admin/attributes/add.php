<form class="form-horizontal" method="post" enctype="multipart/form-data">
	...
	<div class="control-group <?=Arr::get($errors, 'solid_size') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'solid_size')?>" class="input-block-level" name="solid_size" id="solid_size"  />
	...
	<div class="control-group <?=Arr::get($errors, 'frac_size') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'frac_size')?>" class="input-block-level" name="frac_size" id="frac_size"  />
	...
	<div class="control-group <?=Arr::get($errors, 'prefix') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'prefix')?>" class="input-block-level" name="prefix" id="prefix"  />
	...
	<div class="control-group <?=Arr::get($errors, 'unit') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'unit')?>" class="input-block-level" name="unit" id="unit"  />
	...
	<div class="control-group <?=Arr::get($errors, 'max_text_length') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'max_text_length')?>" class="input-block-level" name="max_text_length" id="max_text_length"  />
	...
	<div class="control-group <?=Arr::get($errors, 'is_textarea') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'is_textarea')?>" class="input-block-level" name="is_textarea" id="is_textarea"  />
	...
	<div class="control-group <?=Arr::get($errors, 'type') ? 'error' : ''?>">
		...
		<div class="controls">
			<?=Form::select('type', array('text' => 'text', 'integer' => 'integer', 'numeric' => 'numeric', 'boolean' => 'boolean', 'list' => 'list')) ?>
	...
	<div class="control-group <?=Arr::get($errors, 'comment') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'comment')?>" class="input-block-level" name="comment" id="comment"  />
	...
	<div class="control-group <?=Arr::get($errors, 'is_prefix') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'is_prefix')?>" class="input-block-level" name="is_prefix" id="is_prefix"  />
	...
	<div class="control-group <?=Arr::get($errors, 'is_unit') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'is_unit')?>" class="input-block-level" name="is_unit" id="is_unit"  />
	...
	<div class="control-group <?=Arr::get($errors, 'parent') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'parent')?>" class="input-block-level" name="parent" id="parent"  />
	...
	<div class="control-group <?=Arr::get($errors, 'is_price') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'is_price')?>" class="input-block-level" name="is_price" id="is_price"  />
	...
	<div class="control-group <?=Arr::get($errors, 'is_descr') ? 'error' : ''?>">
		...
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'is_descr')?>" class="input-block-level" name="is_descr" id="is_descr"  />
	...
	<div class="control-group <?=Arr::get($errors, 'id_tr') ? 'error' : ''?>">
		<label class="control-label">is_descr:</label>
		<div class="controls">
			<input type="text" value="<?=Arr::get($_POST, 'id_tr')?>" class="input-block-level" name="id_tr" id="id_tr"  />
