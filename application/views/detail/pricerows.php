...
<div class="pricelist-cont">
	...
	<div class="search-tool oh">	
		...
		<? if (count($pricerows) >= 49): ?>
			<div class="pricelistcontrol oh fr" data-object-id="<?=$ObjectInfo->id?>">
...
<table class="bs-table bs-table-hover bs-table-condensed mt20 pricerows_body">
	<?php $this->load->view('blocks/detail/pricerows_rows', array("pricerows" =>$pricerows)); ?>
</table>
<? if (count($pricerows) >= 49): ?>
	<div class="pricelistcontrol oh mt20 mb20" data-object-id="<?=$ObjectInfo->id?>">
		<div class="cont fr">
			<span onclick="_pricecontrol.price_prev();" class='navi-left' title='Назад'></span>
