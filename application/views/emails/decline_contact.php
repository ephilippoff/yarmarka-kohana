	...
	<body style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 14px; margin: 0; padding: 0;">
		...
		<div class="email_cont" style="max-width: 800px; margin: 0 auto; padding: 0px 15px;">
			...
			<div class="content" style="text-align: center; margin-top: 30px;" align="center">
				<div class="img" style="display: inline-block; width: 100%; max-width: 270px; text-align: center;" align="center">
					<img src="http://yarmarka.biz/static/develop/production/images/4_165.jpg">
				</div>
				<div class="text" style="text-align: left; line-height: 1.6; display: inline-block; width: 100%; max-width: 500px; margin-bottom: 15px;" align="left">
					...
					Объявления были сняты с публикации, т.к. телефон <?=$phone?> не прошел проверку:
					<?php foreach ($objects as $object) : ?>
						<p class="p3"><a style="color: #d44234;" href="<?=$object->get_url()?>"><?=$object->title?></a></p>
					<?php endforeach ?>
					<a style="color: #d44234;" href="http://feedback.yarmarka.biz">Связаться с тех. поддержкой</a>
