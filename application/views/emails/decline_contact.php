...
<table align="center" cellspacing="0" cellpadding="0" border="0" width="800" style="color:#000;font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;font-size: 14px;border-collapse: collapse;">
		...
		<tr>
			...
			<tr><td colspan="2" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;line-height: 15px;">Объявления были сняты с публикации, т.к. телефон <?=$phone?> не прошел проверку:</td></tr>
			<tr>
				<td colspan="2" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;line-height: 15px;">
					...
					<?php endforeach ?>			
						...
						<tr><td colspan="2" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;line-height: 15px;"><a style="color: #d44234;" href="http://feedback.yarmarka.biz">Связаться с тех. поддержкой</a></td></tr>						
