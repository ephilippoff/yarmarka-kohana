...
<table align="center" cellspacing="0" cellpadding="0" border="0" width="800" style="color:#000;font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;font-size: 14px;border-collapse: collapse;">
		...
		<tr>
			...
			<tr>
				<td colspan="2" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;line-height: 0px;">
						<p class="p3"><a style="color: #d44234;" href="<?=URL::site('/user/employers?method=accept_request&id='.$request_user->id, 'http')?>">ДА</a></p>	
				</td>
			</tr>
			...
			<tr>
				<td colspan="2" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;line-height: 0px;">
						<p class="p3"><a style="color: #d44234;" href="<?=URL::site('/user/employers?method=decline_request&id='.$request_user->id, 'http')?>">НЕТ</a> </p>	
				</td>
			</tr>
