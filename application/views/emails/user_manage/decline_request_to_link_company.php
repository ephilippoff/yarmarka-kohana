		...
		<tr>
			...
			<tr>
				<td colspan="2" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;line-height: 15px;">
						<p class="p3">Компания <?=$request_user->org_name ?> (<?=$request_user->email ?>) НЕ подтвердила привязку вашей учетной записи. Вы не можете подавать объявления от имени этой компании</p>	
				</td>
			</tr>
			...
			<tr>
				<td colspan="2" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;line-height: 15px;">
						<p class="p3"><a style="color: #d44234;" href="<?=URL::site('/user/userinfo', 'http')?>">Перейти к вашим учетным данным</a></p>	
				</td>
			</tr>
