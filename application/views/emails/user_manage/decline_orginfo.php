...
<body  align="center">
 ...
 <tbody style="color:#333333;font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;font-size: 14px;">
			...
			<tr><td colspan="2" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;line-height: 15px;">Модератор отклонил загруженный ИНН по причине:</td></tr>
			<tr>
			...
			<tr>
				<td colspan="2" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;line-height: 15px;">
						<p class="p3">Вы можете повторно загрузить ИНН через <a href="<?=URL::site('/user/orginfo', 'http')?>">страницу редактирвоания информации о компании</a></p>	
				</td>
			</tr>
