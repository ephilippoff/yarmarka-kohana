...
<body style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 14px; margin: 0; padding: 0;">
	...
	<div class="email_cont" style="max-width: 800px; margin: 0 auto; padding: 0px 15px;">
		...
		<div class="content" style="text-align: center; margin-top: 30px;" align="center">
			...
			<div class="text" style="text-align: center; line-height: 1.6; display: inline-block; width: 100%; max-width: 630px; margin-bottom: 15px;" align="center">
				<h2 style="font-size: 1.5em; display: block; text-align: center; margin-bottom: 15px;" align="center">Здравствуйте!</h2>
				Добро пожаловать на сайт «Ярмарка-онлайн»! <br>
				Чтобы активировать Ваш аккаунт, перейдите по следующей ссылке:<br><a style="color: #d44234; text-decoration: none;" href="http://yarmarka.biz/user/account_verification/<?=$activationCode?>"> http://yarmarka.biz/user/account_verification/<?=$activationCode?></a><br>
				Если приведенная ссылка не открывается, скопируйте ее и вставьте в адресную строку браузера. <br>
				Если Вы не регистрировались на «Ярмарка-онлайн», ничего не делайте или просто удалите это письмо - аккаунт создан не будет. <br>
