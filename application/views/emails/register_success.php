...
<body  align="center">
  ...
  <table align="center" cellspacing="0" cellpadding="0" border="0" width="800" style="color:#000;font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;font-size: 14px;border-collapse: collapse;">
		...
		<tr>
			<td width="180"><img src="<?=URL::site('static/develop/production/images/2_165.jpg', 'http')?>" /></td>
			<td>
			...
			<tr><td colspan="2" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;line-height: 15px;">Добро пожаловать на сайт «Ярмарка-онлайн»!</td></tr>
			<tr><td colspan="2" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;line-height: 15px;">
					Чтобы активировать Ваш аккаунт, перейдите по следующей ссылке:<br>
					<a style="color: #d44234;" href="<?=URL::site("/user/account_verification", "http")?>/<?=$activationCode?>">
						<span class="s3"><?=URL::site("/user/account_verification", "http")?>/<?=$activationCode?></span>
					</a><br />
