							...
							<? if (!$already_agree): ?>
								...
								<p><h2>Зачем нужна массовая загрузка объявлений?</h2>
									<ul>
										...
										<li>- У вас нет базы данных, но есть список объектов/товаров/услуг, который вы ведете в Excel. Наш сайт может стать хранилищем ваших предложений. В дальнейшем будет не только загрузка, но и выгрузка.</li>
